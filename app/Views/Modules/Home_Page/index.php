...
<section>
  ...
  <div class="row background-row d-flex container-fluid" style="align-items: end; justify-content: center">
    <div class="d-flex" style="justify-content: center">
      ...
      <button id="btn_Olahraga" class="text-danger border-0 fs-2 col-sm-2 p-3 btn-hover" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample3" aria-expanded="false" aria-controls="multiCollapseExample3">
        Olahraga
      </button>
    </div>
  </div>
