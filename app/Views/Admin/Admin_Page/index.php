        ...
        <div class="container text-center mt-3">
            <div class="row">
                <div class="col-lg-3" id="approved">
                    <a href="<?= base_url('approved'); ?>" class="text-decoration-none text-dark">
                ...
                <div class="col-lg-3" id="submission">
                    <a href="<?= base_url('submission'); ?>" class="text-decoration-none text-dark">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <div class="icon-contain">
                                    <div class="row">
                ...
                <div class="col-lg-3">
                    <a href="<?= base_url('report'); ?>" class="text-decoration-none text-dark">
            ...
            <div class="row mt-3">
                <div class="col-lg-3" id="cancellation">
                    <a href="<?= base_url('cancellation'); ?>" class="text-decoration-none text-dark">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <div class="icon-contain">
                                    <div class="row">
