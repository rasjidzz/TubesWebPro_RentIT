    ...
    <div class="card card-body" style="background-color: #F4F5F6;">
        <table class="table table-responsive table-hover">
            ...
            <tbody>
                <tr>
                    <td>
                        <img src="Assets/GedungPerkuliahan/TULT/TULT-2.jpg" alt="Gedung" width="90px" height="90px">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <img src="Assets/Olahraga/LapanganTennis/Tennis-2.jpg" alt="Olahraga" width="90px" height="90px" id="gambar_lapangan">
                    </td>
                    <td>
                        <p>UJANG KAYAT</p>
                    </td>
